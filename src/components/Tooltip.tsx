...
const Tooltip = () => {
  return (
    <section className="flex justify-start items-center gap-4 flex-wrap pt-6">
      ...
      >
        ...
        <span className="absolute opacity-0 group-hover:opacity-100 group-hover:text-gray-700 font-bold text-sm group-hover:-translate-y-12 transition-all duration-500 pointer-events-none">
          LinkedIn
        </span>
      </a>
